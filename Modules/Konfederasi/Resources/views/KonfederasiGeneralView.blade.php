...
<div class="card">
    <div class="card-header header-elements-inline" data-toggle="collapse" href="#accordion-item-default2">
                 <h6 class="card-title"><i class="icon-users4 mr-2"></i> Informasi Umum Konfederasi </h6>
    ...
    <div id="accordion-item-default2" class="collapse show" data-parent="#accordion-default">
        ...
        <form action="{{ route('konfederasi.generalSave') }}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}    
            <div class="card-body">
                <div class="row"> 
                        <div class="col-md-6">
  ...
  {{--                   <div class="col-md-4">
                            <div class="form-group {{ $errors->has('alamat') ? 'has-error' : '' }}">
                                ...
                                <input type="text" name="afiliasi" class="form-control" placeholder="afiliasi" value="{{ old('afiliasi') }}" autocomplete="off" >
                                <span class="text-danger">{{ $errors->first('afiliasi') }}</span>
                            </div>

                            <div class="form-group {{ $errors->has('telp') ? 'has-error' : '' }}">
                                <label>Nama Singkat Afiliasi Internasional :</label>
                                <input type="text" name="ns_afiliasi" class="form-control" placeholder="ns_afiliasi" value="{{ old('ns_afiliasi') }}" autocomplete="off" >
                    ...
                    <div class="col-md-4">
                            <div class="form-group {{ $errors->has('alamat') ? 'has-error' : '' }}">
                                ...
                                <input type="text" name="afiliasi_federasi" class="form-control" placeholder="afiliasi_federasi" value="{{ old('afiliasi_federasi') }}" autocomplete="off" >
                                <span class="text-danger">{{ $errors->first('afiliasi_federasi') }}</span>
                            </div>

                            <div class="form-group {{ $errors->has('telp') ? 'has-error' : '' }}">
                                <label>Nama Singkat Afiliasi Federasi :</label>
                                <input type="text" name="ns_afiliasi_federasi" class="form-control" placeholder="ns_afiliasi_federasi" value="{{ old('ns_afiliasi_federasi') }}" autocomplete="off" >
                                <span class="text-danger">{{ $errors->first('ns_afiliasi_federasi') }}</span>
                            </div>
                    </div> --}}
                    <div class="col-md-4">
                            <div class="form-group {{ $errors->has('alamat') ? 'has-error' : '' }}">
                                <label>Afiliasi konfederasi Internasional :</label>
                            ...
                            <div class="form-group {{ $errors->has('telp') ? 'has-error' : '' }}">
                                <label>Nama Singkat Afiliasi konfederasi Internasional :</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                <label>Email :</label>
                                <input type="email" name="email" class="form-control" placeholder="Email" value="{{ $model->email }}" autocomplete="off" required="">
...
@push('scripts')
  ...
  <script type="text/javascript">
          $('.form-control-uniform').uniform({
            ...
            fileButtonHtml: 'Upload Anggaran'
        });
  </script>
  <script type="text/javascript">
     $(".styled").uniform();

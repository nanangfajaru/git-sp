...
<div class="card">
    <div class="card-header header-elements-inline" data-toggle="collapse" href="#accordion-item-default2">
                 <h6 class="card-title"><i class="icon-shield2 mr-2"></i> Kirim Pemberitahuan Serikat Pekerja </h6>
    ...
    <form action="{{ route('serikatpekerja.kirimSave') }}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}  
...
{{--                             <div class="form-group">
                ...
                <div class="form-group row">
                    <div class="col-lg-10">
                        ...
                        <button type="submit" class="btn bg-{{ \Config::get('app.theme')}}">Kirim Pemberitahuan <i class="icon-enter ml-2"></i></button>
                    </div>
                </div>

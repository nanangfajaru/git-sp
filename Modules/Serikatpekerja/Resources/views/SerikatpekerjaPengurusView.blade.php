...
<div class="card">
    <div class="card-header header-elements-inline" data-toggle="collapse" href="#accordion-item-default2">
                 <h6 class="card-title"><i class="icon-users4 mr-2"></i> Pengurus Serikat Pekerja </h6>
    ...
    <div id="accordion-item-default2" class="collapse show" data-parent="#accordion-default">
        ...
        <form action="{{ route('serikatpekerja.pengurusSave') }}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}    
            <div class="card-body">
                <div class="row"> 
                        <div class="col-md-12">
...
<script>
    $(document).ready(function() { 
        $('#TableId').DataTable({
            ...
            ajax: {
                ...
                url: "{{ route('serikatpekerja.apiPengurus') }}",
                type: "POST",
                data: {
    ...
    $('.modal-footer').on('click', '.btn_delete', function() {
        $.ajax({
            type: 'post',
            url: '{{ route('serikatpekerja.destroyPengurus') }}',
            data: {

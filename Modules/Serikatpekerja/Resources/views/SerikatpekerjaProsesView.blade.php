...
<div class="card">
    <div class="card-header header-elements-inline" data-toggle="collapse" href="#accordion-item-default2">
                 <h6 class="card-title"><i class="icon-users4 mr-2"></i> Memproses Serikat Pekerja </h6>
    ...
    <div id="accordion-item-default2" class="collapse show" data-parent="#accordion-default">
        ...
        <form action="{{ route('serikatpekerja.prosesSave') }}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}    
            <div class="card-body">
                <div class="row"> 
                        <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <legend class=" border-bottom-{{ \Config::get('app.theme') }}"><i class="icon-clipboard5 mr-2"></i>
                            Merubah Status Serikat Pekerja
                        </legend>
                    </div>
                </div>
                <div class="row">
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('status_sp') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-group select" name="status_sp">
                                      ...
                                      <option value="6">PENCABUTAN PENCATATAN</option>
                                    </select>

...
<div class="card">
    <div class="card-header header-elements-inline" data-toggle="collapse" href="#accordion-item-default2">
                 <h6 class="card-title">
                    <i class="icon-shield2 mr-2"></i> Detail Serikat Pekerja 
                </h6>
            ...
            <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="keterangan" name="keterangan" class="form-control" placeholder="keterangan" value="{{ $model->keterangan }}" required="" autocomplete="off" readonly="">
                            </div>
                        </div>
            </div>
            <div class="row">

...
<div class="card">
    <div class="card-header header-elements-inline" data-toggle="collapse" href="#accordion-item-default2">
                 <h6 class="card-title"><i class="icon-users4 mr-2"></i> Informasi Umum Serikat Pekerja </h6>
    ...
    <div id="accordion-item-default2" class="collapse show" data-parent="#accordion-default">
        ...
        <form action="{{ route('serikatpekerja.generalSave') }}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}    
            <div class="card-body">
                <div class="row"> 
                        <div class="col-md-6">
                    ...
                    <div class="col-md-4">
                        {{-- <b class="text-danger">* --}}
                            <div class="form-group {{ $errors->has('alamat') ? 'has-error' : '' }}">
                                <label>Afiliasi Internasional : </b></label>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group {{ $errors->has('perusahaan') ? 'has-error' : '' }}">
                                ...
                                <div class="form-group row" id="perusahaan">
                                     &nbsp;
                                     &nbsp;
                                    <input type="radio" value="dalam" class="styled" name="perusahaan" id="dalam" {{$dalam}} >
                                     &nbsp; Di Perusahaan
                                     &nbsp;
                                    <input type="radio" value="luar" class="styled" name="perusahaan" id="luar" {{$luar}}>
                                     &nbsp; Di luar Perusahaan
                                </div>

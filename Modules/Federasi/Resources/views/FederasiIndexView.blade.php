...
{{-- <div class="card">
    ...
    <div id="accordion-item-default2" class="collapse" data-parent="#accordion-default">
        ...
        <form action="{{ route('federasi.export') }}" method="post">
            {{csrf_field()}}    
            <div class="card-body">
                <div class="row"> 
                        <div class="col-md-4">
...
<div class="card">
    <div class="card-header header-elements-inline">
        {{-- <legend class="font-weight-semibold border-bottom-teal-400"><i class="icon-bookmark2 mr-2"></i> Pengajuan federasi

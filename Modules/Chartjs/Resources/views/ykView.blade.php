...
<div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="col-md-12">
                <legend class="font-weight-semibold border-bottom-teal-400"><i class="icon-pie-chart mr-2"></i> Yogyakarta Berdasarkan Jenis Kelamin - 2017 </legend>
                </div>
                <div class="card-body">
                   {!! $pie->render() !!}
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="col-md-12">
                <legend class="font-weight-semibold border-bottom-teal-400"><i class="icon-user mr-2"></i> Yogyakarta Berdasarkan Wilayah Kerja - 2017 </legend>
                </div>
                <div class="card-body">
                   {!! $pendidikan->render() !!}
                </div>
